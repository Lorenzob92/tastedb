        ...
        <div className="rounded-2xl border border-white/10 bg-[#0a0a12]/80 backdrop-blur-xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col gap-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg border border-white/10 bg-white/5 text-sm text-zinc-300 hover:bg-white/10 transition-colors"
            >
